	...
	<div class="page-header-content">
		<div class="page-title">
			<h4>
				...
				<span class="text-semibold">Perusahaan </span> - Barang Jasa
				<small class="display-block">Data barang jasa perusahaan</small>
			</h4>
		</div>

		<div class="heading-elements">
			<div class="heading-btn-group" style="margin-top: -10px;">
				<a href="<?=base_url();?>add_barang_jasa_c" class="btn btn-success btn-float "><i class="icon-plus-circle2"></i><span>Tambah Data</span></a>
			</div>
		</div>
	</div>
</div>
...
<div class="panel panel-flat">
	<div class="panel-heading">
		<h5 class="panel-title">Data Barang Jasa</h5>
		<div class="heading-elements">
			<ul class="icons-list">
	...
	<table class="table table-bordered datatable-basic">
		<thead>
			<tr>
				...
				<th class="bg-info" style="width: 20%;">KODE</th>
				<th class="bg-info" style="width: 10%;">NAMA</th>
				<th class="bg-info" style="width: 20%;">JENIS BARANG</th>
				<th class="bg-info" style="width: 20%;">SATUAN</th>
				<th class="bg-info" style="width: 10%;">STOK</th>
