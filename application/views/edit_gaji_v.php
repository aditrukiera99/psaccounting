	...
	<div class="page-header-content">
		<div class="page-title">
			<h4>
				...
				<span class="text-semibold">Perusahaan </span> - FOB
				<small class="display-block">Data FOB perusahaan</small>
			</h4>
		</div>
							...
							<form class="form-horizontal" action="<?=base_url().$post_url;?>" method="post">
								<fieldset class="content-group"><legend class="text-bold">Form Edit Data</legend>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" class="form-control" value="<?=$dt->NAMA;?>" name="nama" placeholder="Masukkan Nama">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" name="tipe" value="<?=$dt->TIPE;?>" class="form-control" readonly>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" name="bayar" value="<?=$dt->BAYAR;?>" class="form-control" readonly>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<select class="select-search" name="akun">
												<option value="<?=$dt->AKUN;?>"><?=$dt->AKUN;?></option>
												<?php
