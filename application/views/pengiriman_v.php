...
<div class="panel panel-flat">
	<div class="panel-heading">
		<h5 class="panel-title">Data pengiriman</h5>
		<div class="heading-elements">
			<ul class="icons-list">
	...
	<table class="table table-bordered datatable-basic">
		...
		<tbody>
			...
			<tr>
				<td><?=$i;?></td>
				<td><?=$value->NAMA;?></td>
				<td><a href="<?=base_url();?>pengiriman_c/ubah_data/<?=$value->ID;?>"><button class="btn btn-success"><i class="icon-pencil5"></i> Edit</button></a>
