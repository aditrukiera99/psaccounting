	...
	<div class="page-header-content">
		<div class="page-title">
			<h4>
				...
				<span class="text-semibold">Kas & Bank </span> - Pembayaran
				<small class="display-block">Data Pembayaran Perusahaan</small>
			</h4>
		</div>
							...
							<form class="form-horizontal" action="<?=base_url()?>add_proyek_c" method="post">
								<fieldset class="content-group">
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" class="form-control" name="no_cek" placeholder="No Cek....." required>
										</div>
									</div>

									<div class="form-group">
										<label class="control-label col-lg-2">Dari Kas/Bank</label>
										<div class="col-lg-10">
									...
									<div class="form-group">
										<label class="control-label col-lg-2">Ke Kas/Bank</label>
										<div class="col-lg-10">
											<select name="kas_bank" class="select-search">
												<?php 
													foreach ($data_akun_kas as $key => $value) {
									...
									<div class="form-group">
										<label class="control-label col-lg-2">Nilai Transfer</label>
										<div class="col-lg-10">
											<input type="text" class="form-control" onkeyup="FormatCurrency(this);" name="no_bukti" placeholder="No Cek....." required>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<textarea class="form-control" name="transfer"></textarea>
										</div>
									</div>
									
								
									<legend class="text-bold">Biaya Transfer</legend>
