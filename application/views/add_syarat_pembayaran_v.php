...
<div class="panel panel-flat">
						...
						<div class="panel-body">
							...
							?>
							<form class="form-horizontal" action="<?=base_url()?>add_syarat_pembayaran_c" method="post">
								<fieldset class="content-group"><legend class="text-bold">Form Input Data</legend>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" class="form-control" name="antara" placeholder="Hari">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" name="tempo" class="form-control" placeholder="Hari">
										</div>
									</div>
