	...
	<div class="page-header-content">
		<div class="page-title">
			<h4>
				...
				<span class="text-semibold">Persediaan </span> - Kategori Barang
				<small class="display-block">Data kategori barang perusahaan</small>
			</h4>
		</div>

		<div class="heading-elements">
			<div class="heading-btn-group" style="margin-top: -10px;">
				<a href="<?=base_url();?>add_kategori_barang_c" class="btn btn-success btn-float "><i class="icon-plus-circle2"></i><span>Tambah Data</span></a>
			</div>
		</div>
	</div>
</div>
...
<div class="panel panel-flat">
	<div class="panel-heading">
		<h5 class="panel-title">Data kategori barang</h5>
		<div class="heading-elements">
			<ul class="icons-list">
	...
	<table class="table table-bordered datatable-basic">
		...
		<tbody>
			...
			<tr>
				...
				<td><?=$value->NAMA;?></td>
				<td><?=$value->STATUS;?></td>
				<td><a href="<?=base_url();?>kategori_barang_c/ubah_data/<?=$value->ID;?>"><button class="btn btn-success"><i class="icon-pencil5"></i> Edit</button></a>
