	...
	<table class="table table-bordered datatable-basic">
		<thead>
			<tr>
				...
				<th class="bg-info" style="width: 10%;">Kode Akun</th>
				<th class="bg-info" style="width: 35%;">Nama</th>
				<th class="bg-info" style="width: 20%;">Tipe Akun</th>
				<th class="bg-info" style="width: 15%;">Saldo</th>
		...
		<tbody>
			...
			<tr>
				...
				<td><?=$value->SALDO;?></td>
				<td><a href="<?=base_url();?>akun_c/ubah_data/<?=$value->ID;?>"><button class="btn btn-success"><i class="icon-pencil5"></i> Edit</button></a>
