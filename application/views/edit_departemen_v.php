							...
							<form class="form-horizontal" action="<?=base_url()?>add_departemen_c" method="post">
								<fieldset class="content-group"><legend class="text-bold">Data Departemen</legend>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" class="form-control" name="nama" value="<?=$dt->DEPARTEMEN;?>" placeholder="Masukkan Nama" required>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<textarea name="ket" class="form-control"><?=$dt->DEPARTEMEN;?></textarea>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="date" name="tgl" value="<?=$dt->DEPARTEMEN;?>" class="form-control">
										</div>
									</div>
