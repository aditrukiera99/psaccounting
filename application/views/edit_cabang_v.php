							...
							<form class="form-horizontal" action="<?=base_url().$post_url;?>" method="post">
								<fieldset class="content-group"><legend class="text-bold">Form Edit Data</legend>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" name="alamat" class="form-control" value="<?=$dt->ALAMAT;?>" placeholder="Masukkan Alamat">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" name="kota" class="form-control" value="<?=$dt->KOTA;?>" placeholder="Masukkan kota">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" name="provinsi" class="form-control" value="<?=$dt->PROVINSI;?>" placeholder="Masukkan provinsi">
										</div>
									</div>
