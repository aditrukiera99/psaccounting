										...
										<div class="tab-content">
											<div class="tab-pane active" id="highlighted-justified-tab1">
												<div class="col-md-6">
													<div class="form-group">
														...
														<div class="col-lg-10">
															<input  value="<?=$dt->NAMA_LENGKAP;?>" type="text" class="form-control" name="nama_lengkap" placeholder="Masukkan Nama">
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-lg-10">
															<input  value="<?=$dt->POSISI;?>" type="text" name="posisi" class="form-control" placeholder="Masukkan Jabatan">
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-lg-10">
															<input  value="<?=$dt->EMAIL;?>" type="email" name="email" class="form-control" placeholder="Masukkan Email">
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-lg-10">
															<input  value="<?=$dt->HANDPHONE;?>" type="text" name="handphone" class="form-control" placeholder="Masukkan nomor hp">
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-lg-10">
															<input  value="<?=$dt->NO_TELP_RUMAH;?>" type="text" class="form-control" name="no_rumah" placeholder="Masukkan no telp rumah">
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-lg-10">
															<input  value="<?=$dt->BBM;?>" type="text" name="bbm" class="form-control" placeholder="Masukkan pin bbm">
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-lg-10">
															<input  value="<?=$dt->WEBSITE;?>" type="text" name="web" class="form-control" placeholder="Masukkan website">
														</div>
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
														...
														<div class="col-lg-10">
															<input  value="<?=$dt->KEWARGANEGARAAN;?>" type="text" class="form-control" name="kewarganegaraan" placeholder="Masukkan Kewarganegaraan">
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-lg-10">
															<input  value="<?=$dt->ID_KARYAWAN;?>" type="text" name="id_karyawan" class="form-control" placeholder="Masukkan ID Karyawan">
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-lg-10">
															<input  value="<?=$dt->TGL_MASUK;?>" type="text" name="tgl_masuk" class="form-control daterange-single" value="<?php echo date('m/d/Y'); ?>">
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-lg-10">
															<input  value="<?=$dt->NO_KTP;?>" type="text" name="no_ktp" class="form-control" placeholder="Masukkan No KTP">
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-lg-10">
															<select value="<?=$dt->DEPARTEMEN;?>"  class="select-search" name="departemen">
																<option value="<?=$dt->ID;?>"><?=$dt->DEPARTEMEN;?></option>
																<?php 
													...
													<div class="form-group">
														...
														<div class="col-lg-10">
															<textarea class="form-control" name="catatan"><?=$dt->CATATAN;?></textarea>
														</div>
													</div>
												</div>
											</div>
											...
											<div class="tab-pane" id="highlighted-justified-tab2">
												<div class="form-group">
													...
													<div class="col-lg-10">
														<input  value="<?=$dt->ALAMAT;?>" type="text" class="form-control" name="alamat" placeholder="Masukkan Nama">
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-lg-10">
														<input  value="<?=$dt->KOTA;?>" type="text" name="kota" class="form-control" placeholder="Masukkan Jabatan">
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-lg-10">
														<input  value="<?=$dt->PROVINSI;?>" type="text" name="provinsi" class="form-control" placeholder="Masukkan Email">
													</div>
												</div>
											...
											<div class="tab-pane" id="highlighted-justified-tab3">
												<div class="form-group">
													...
													<div class="col-lg-10">
														<input  value="<?=$dt->NO_NPWP;?>" type="text" class="form-control" name="no_npwp" placeholder="Masukkan Nama">
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-lg-10">
														<select name="status_pekerja" class="select-search">
															<option value="<?=$dt->STATUS_PEKERJA;?>"><?=$dt->STATUS_PEKERJA;?></option>
												...
												<div class="form-group">
													...
													<div class="col-lg-10">
														<input  value="<?=$dt->DIKENAKAN_PKTP;?>" type="chekbox" class="form-control" name="dikenakan_pktp">
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-lg-10">
														<select value="<?=$dt->STATUS_PKTP;?>"  name="status_pktp" class="select-search">
