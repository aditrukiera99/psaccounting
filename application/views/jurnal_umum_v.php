							...
							<form class="form-horizontal" action="<?=base_url()?>add_proyek_c" method="post">
								<fieldset class="content-group">
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" class="form-control" name="nama_kontak" placeholder="Masukkan nomor" required>
										</div>
									</div>
                                                ...
                                                <table class="table table-bordered table-hover table-striped">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="bg-success" style="width: 10%;">DEBIT</th>
                                                            <th class="bg-success" style="width: 10%;">KREDIT</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody id="item_row">
                                                    ...
                                                    <tfoot>
                                                    	<tr>
                                                    		...
                                                    		<td class="" ><input type="hidden" name="debit_tota" id="debit"><h4 id="debit_txt"></h4></td>
                                                    		<td class="" ><input type="hidden" name="kredit_tota" id="kredit"><h4 id="kredit_txt"></h4></td>
                                                    	</tr>
                                                    </tfoot>
                                                </table>
										</div>
        ...
        $.ajax({
            ...
            success : function(res){   
                ...
                var isi  =  '<tr>'+
                                ...
                                '</td>'+
                                '<td style="vertical-align: middle;">'+
                                	'<input id="qty_'+id2+'" value="1" class="form-control" type="text" name="kredit[]" onkeyup="FormatCurrency(this);" style="width: 100%; text-align: center;" required>'+
                                '</td>'+
