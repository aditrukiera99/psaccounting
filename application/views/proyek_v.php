	...
	<div class="page-header-content">
		<div class="page-title">
			<h4>
				...
				<span class="text-semibold">Perusahaan </span> - Proyek
				<small class="display-block">Data proyek perusahaan</small>
			</h4>
		</div>

		<div class="heading-elements">
			<div class="heading-btn-group" style="margin-top: -10px;">
				<a href="<?=base_url();?>add_proyek_c" class="btn btn-success btn-float "><i class="icon-plus-circle2"></i><span>Tambah Data</span></a>
			</div>
		</div>
	</div>
</div>
...
<div class="panel panel-flat">
	<div class="panel-heading">
		<h5 class="panel-title">Data Proyek</h5>
		<div class="heading-elements">
			<ul class="icons-list">
	...
	<table class="table table-bordered datatable-basic">
		<thead>
			<tr>
				<th class="bg-slate">No Proyek</th>
				<th class="bg-slate">Nama Proyek</th>
		...
		<tbody>
			...
			?>
			<tr>
				<td><?=$value->NO_PROYEK;?></td>
				<td><?=$value->NAMA_PROYEK;?></td>
				<td><a href="<?=base_url();?>proyek_c/ubah_data/<?=$value->ID;?>"><button class="btn btn-success"><i class="icon-pencil5"></i> Edit</button></a>
